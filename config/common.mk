...
# Viper4Android
PRODUCT_COPY_FILES += \
    vendor/liquid/prebuilt/common/etc/viper/libv4a_fx_kk_NEON_HQ.so:system/lib/soundfx/libv4a_fx_kk_NEON_HQ.so
    vendor/liquid/prebuilt/common/etc/viper/ViPER4Android.apk:system/priv-app/ViPER4Android.apk
